<div>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <div class="mt-4">
                <a href="{{route('pressures.list',$patient_id)}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-4">
                    View Blood pressure
                </a>
                <a href="{{route('pressures.create',$patient_id)}}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
