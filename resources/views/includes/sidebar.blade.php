<aside class="w-full md:w-64 bg-gray-800 md:min-h-screen px-4" x-data="{ open: false }">
    <div class="flex items-center justify-between bg-gray-900 p-4 h-16">
        ...
        <a href="{{route('patients.list')}}" class="flex items-center">
            ...
            <span class="text-gray-300 text-xl font-semibold mx-2">Blood pressure dashboard</span>
        </a>

    </div>
    <div class="px-2 py-6 md:block" :class="open ? 'block': 'hidden'" >
        <ul>
            <li class="px-2 py-3 hover:bg-gray-900 rounded {{ request()->routeIs('patients.list') ? 'bg-gray-500' : '' }}">
                <a href="{{route('patients.list')}}" class="flex items-center">
                    ...
                    <span class="mx-2 text-gray-300">Patient list</span>
                </a>
            </li>
            <li class="px-2 py-3 mt-2 hover:bg-gray-900 rounded {{ request()->routeIs('patients.create') ? 'bg-gray-500' : '' }}">
                <a href="{{route('patients.create')}}" class="flex items-center">
                    <svg class="w-6 text-gray-500" fill="none" stroke-linecap="round"
                         stroke-linejoin="round"
                         stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path
                    ...
                    <span class="mx-2 text-gray-300">Create patient</span>
                </a>
            </li>
            <li class="px-2 py-3 mt-2 hover:bg-gray-900 rounded {{ request()->routeIs('users.list') ? 'bg-gray-500' : '' }}">
                <a href="{{route('users.list')}}" class="flex items-center">
                    ...
                    <span class="mx-2 text-gray-300">User list</span>
                </a>
            </li>
            <li class="px-2 py-3 mt-2 hover:bg-gray-900 rounded {{ request()->routeIs('users.create') ? 'bg-gray-500' : '' }}">
                <a href="{{route('users.create')}}" class="flex items-center">
                    ...
                    <span class="mx-2 text-gray-300">Create user</span>
                </a>
            </li>
        </ul>
</aside>
